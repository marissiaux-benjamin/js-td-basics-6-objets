...
console.log(`Je m'appelle ${['Ben']} ${['Maru']}, j'ai ${['22']} ans, je suis ${['Étudiant']} et je suis ${['Belge']}`);
...
moi.etatCivil = 'marié';
console.log(moi);
console.log(`Je m'appelle ${moi.prenom} ${moi.nom}, j'ai ${moi.age} ans, je suis à présent ${moi.profession} ${moi.nationalite} et je suis ${moi.etatCivil}.`);
